export default function registerHandlebarsHelpers() {
    ...
    Handlebars.registerHelper("canReadyArmor", function (selectedArmor, allArmor) {
        let canReady = true;
        ...
        return canReady ? "" : "disabled title=\"Cannot equip this accessory while wearing an armored suit\"";
    });
