...
export default class ServerActorData extends CWNDataModel {
    static defineSchema() {
        ...
        return {
            ...
            demons: new fields.ArrayField(new fields.StringField({ required: false, blank: true })),
            nodes: new fields.ArrayField(new fields.StringField({ required: false, blank: true })),
