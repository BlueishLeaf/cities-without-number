...
export default class WeaponItemData extends ModifiableItemData {
  static defineSchema() {
    ...
    return {
      ...
      isBurstFireable: new fields.BooleanField({
        required: true,
        initial: false,
      }),
      ...
      canDealNonLethalDamage: new fields.BooleanField({
        required: true,
        initial: false,
      }),
      damageFormula: new fields.StringField({
        required: true,
        initial: "1d6 + @attributeMod",
      }),

      hasRangedAttack: new fields.BooleanField({
        required: true,
        initial: true,
      }),
      ...
      canDealTraumaticHits: new fields.BooleanField({
        required: true,
        initial: true,
      }),
      ...
      canDealShockDamage: new fields.BooleanField({
        required: true,
        initial: true,
      }),
