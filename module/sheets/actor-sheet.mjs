...
export class CitiesWithoutNumberActorSheet extends ActorSheet {
    ...
    updateReadiedFlag(event) {
        ...
        if (selectedItem.type === "armor" && selectedItem.system.subType === "armor" && selectedItem.system.readied) {
            ...
            otherEquippedArmorItems.forEach(equippedArmorItem => itemUpdates.push({
            ...
            if (selectedItem.system.isSuit) {
                ...
                incompatibleAccessories.forEach(incompatibleAccessory => itemUpdates.push({
    ...
    updateSkillLevel(event) {
        ...
        }], {parent: this.actor}).then(updatedSkill => console.log("Updated skill", updatedSkill));
    }
    ...
    handleSkillRoll(skill, html) {
        ...
        Item.updateDocuments([{
            _id: skill._id,
            system: {attribute: selectedAttributeCode, specialist: selectedSpecialistLevel}
        }], {parent: this.actor}).then(updates => console.log("Updated skill", updates));
